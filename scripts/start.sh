#!/bin/bash
# ==============================================================================
# A9 HMI - Startup Script
# สคริปต์เริ่มต้นแอปพลิเคชัน A9 HMI
# ==============================================================================
# ใช้งาน:
#   ./scripts/start.sh              - รันปกติ (production)
#   ./scripts/start.sh --dev        - รันในโหมด development
#   ./scripts/start.sh --fullscreen - รันแบบเต็มหน้าจอ
# ==============================================================================
